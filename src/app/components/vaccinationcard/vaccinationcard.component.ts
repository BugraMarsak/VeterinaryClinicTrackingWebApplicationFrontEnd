...
export class VaccinationcardComponent implements OnInit {
  ...
  constructor(private vaccinationCardService:VaccinationcardService,private activatedRoute:ActivatedRoute,private animalInformatinService:AnimalInformationService) { }
