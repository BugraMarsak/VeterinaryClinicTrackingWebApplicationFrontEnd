...
@Component({
  selector: 'app-vaccinationaddbyid',
  templateUrl: './vaccinationaddbyid.component.html',
  styleUrls: ['./vaccinationaddbyid.component.css']
})
export class VaccinationaddbyidComponent implements OnInit {
  addForm:FormGroup;
  ...
  getAnimalId(){
    this.activatedRoute.params.subscribe(params =>{
      this.createAddForm(params["animalId"])
    })
  }
  createAddForm(_animalId:number){

    this.addForm= this.formBuilder.group({
      animalId:[_animalId,Validators.required],
